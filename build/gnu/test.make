...
ifeq ($(CONFIG),Release)
  BINDIR := ../bin/Release
  LIBDIR := ../..
  OBJDIR := obj/examples/test/Release
  OUTDIR := ../bin/Release
  ...
  CXXFLAGS := $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -s -pthread -lrt -L../lib/Release -lnoisepp
...
$(OBJDIR)/main.o: ../../examples/test/main.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o $@ -c $<
